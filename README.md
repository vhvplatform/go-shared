...
[![Go Report Card](https://goreportcard.com/badge/github.com/vhvplatform/go-shared)](https://goreportcard.com/report/github.com/vhvplatform/go-shared)
...
```bash
go get github.com/vhvplatform/go-shared@v1.0.0
```
...
- Open an issue on [GitHub](https://github.com/vhvplatform/go-shared/issues)
